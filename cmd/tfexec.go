...
// (generated by 'make fetch' / platform-bootstrap) are included when present.
func varFileArgs(stackPath, root, env string) []string {
	...
	args := []string{relPath("terraform.tfvars")}

	// fetched.auto.tfvars.json is generated by 'make fetch'; include only if present.
