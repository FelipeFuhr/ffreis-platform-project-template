...
import (
	...
	platformui "github.com/ffreis/platform-project-template/internal/ui"
)
...
var rootCmd = &cobra.Command{
	...
	Short:         "Manage a platform project Terraform stack",
	SilenceErrors: true,
	SilenceUsage:  true,
	PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
		...
		// Skip AWS credential loading for local commands (e.g. version).
